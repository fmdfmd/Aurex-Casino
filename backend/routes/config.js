...
const defaultPaymentMethodsConfig = {
  fiat: [
    ...
    // Rukassa
    { id: 'RUKASSA_CARD', name: 'Карта (Visa/MC/МИР)', iconUrl: '/images/payments/card.png', minDeposit: 1000, maxDeposit: 300000, minWithdraw: 5000, depositFee: 0, withdrawFee: 5, provider: 'rukassa', subtitle: 'от 1 000₽' },
    ...
    { id: 'RUKASSA_CRYPTO', name: 'Крипта (USDT)', iconUrl: '/images/payments/usdt.svg', minDeposit: 100, maxDeposit: 300000, minWithdraw: 1000, depositFee: 0, withdrawFee: 5, provider: 'rukassa', subtitle: 'от 100₽' },
    // Nirvana Pay
